...
void RCSwitch::send(unsigned long code, unsigned int length) {
  ...
  for (int nRepeat = 0; nRepeat < nRepeatTransmit; nRepeat++) {
    this->transmit(protocol.syncFactor); //Added per https://github.com/sui77/rc-switch/issues/468   (OZ)
    ...
    //this->transmit(protocol.syncFactor);  Removed per https://github.com/sui77/rc-switch/issues/468   (OZ)
  }
